<div style="padding: 5px; background: #FFFFFF; width: 1060px;">
	<div style="float: left; width: 700px;">
		...
		<div style="float: left; width: 600px;"><div id="nameED"></div></div>
		<div class="clear"></div>
		<div style="float: left; width: 100px; padding: 3px 5px 12px 0; text-align: right;">Alias :</div>
		<div style="float: left; width: 600px;"><div id="aliasED"></div></div>
		<div class="clear"></div>
	...
	<div style="float: left; width: 350px;">
		...
		<div class="clear"></div>
		<div style="float: left; width: 100px; padding: 3px 5px 12px 0; text-align: right;">&nbsp;</div>
		<div style="float: left; width: 250px;"><div id="btn_thumbnailED"></div></div>
		<div class="clear"></div>
	</div>
	<div class="clear"></div>
</div>